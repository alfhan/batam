...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 06, 2015 at 06:24 AM
...
INSERT INTO `main_menu` (`id`, `parent_id`, `nama`, `url`, `aktif`, `tipe`) VALUES
(1, 0, 'Warga', '#', 1, 'Internal Link'),
(2, 0, 'Bisnis', '#', 1, 'Internal Link'),
(3, 0, 'Pemerintah', '#', 1, 'Internal Link'),
(4, 0, 'Pariwisata', '#', 1, 'Internal Link'),
(5, 1, 'Kesehatan', 'menu/kesehatan', 1, 'Internal Link'),
(6, 1, 'Pendidikan', 'menu/pendidikan', 1, 'Internal Link'),
(7, 1, 'Perumahan', 'menu/perumahan', 1, 'Internal Link'),
(8, 1, 'Transportasi', 'menu/transportasi', 1, 'Internal Link'),
(9, 1, 'Pelabuhan', 'menu/pelabuhan', 1, 'Internal Link'),
(10, 2, 'Bisnis di batam', 'menu/bisnis_di_batam', 1, 'Internal Link'),
(11, 2, 'Infrastruktur', 'menu/infrastruktur', 1, 'Internal Link'),
(12, 2, 'Kawasan Bisnis', 'menu/kawasan_bisnis', 1, 'Internal Link'),
(13, 2, 'Koperasi & UKM', 'menu/koperasi_ukm', 1, 'Internal Link'),
(14, 2, 'Sispadu', 'menu/sispadu', 1, 'Internal Link'),
(15, 3, 'Profil Kota', 'menu/profil_kota', 1, 'Internal Link'),
(16, 3, 'Visi dan Misi', 'menu/visi_misi', 1, 'Internal Link'),
(17, 3, 'Pemerintahan', 'menu/pemerintahan', 1, 'Internal Link'),
(18, 3, 'Surat Kependudukan', 'menu/surat_kependudukan', 1, 'Internal Link'),
(19, 3, 'JDIH Batam', 'menu/jdih', 1, 'Internal Link'),
(20, 4, 'Wisata Bahari', 'menu/wisata_bahari', 1, 'Internal Link'),
(21, 4, 'Wisata Belanja', 'menu/wisata_belanja', 1, 'Internal Link'),
(22, 4, 'Wisata Religi', 'menu/wisata_religi', 1, 'Internal Link'),
(23, 4, 'Wisata Budaya', 'menu/wisata_budaya', 1, 'Internal Link'),
(24, 4, 'Wisata Kuliner', 'menu/wisata_kuliner', 1, 'Internal Link');
...
(1, 'Batam Website', 'Jl. Semolowaru Indah II N-14', '087881596699', 'oenlezsnack@gmail.com', 'logo.jpg', '', '', 'Surabaya, Jawa Timur');
