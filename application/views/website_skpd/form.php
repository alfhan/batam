		...
		<div class="col-md-12">
			<div class="panel panel-success">
				...
				<div class="panel-body">
					<form method="post" action="<?=site_url('website_skpd/simpan')?>" class="tasi-form form-horizontal">
						...
						<div class="form-group">
							...
							<div class="col-md-4">
								<input class="form-control input-sm" name="url" value="<?=@$data['url']?>" />
							</div>
						</div>
						<div class="form-group">
							<div class="col-md-12">
								<a href="<?=site_url('website_skpd')?>" class="btn btn-sm btn-warning"> Back</a>
