	...
	<div class="row">
        <div class="col-md-12">
            <div class="box box-success">
                ...
                <div class="box-body">
                  <div class="col-md-12">
                    <a class="btn btn-sm btn-primary pull-right" href="<?=site_url('website_skpd/form')?>">
                  ...
                  <table class="table table-bordered" id="tbl">
                    ...
                    <tbody>
                      ...
                      <tr>
                          ...
                          <td><?=$row['url']?></td>
                          <td>
                              <a target="_blank" href="<?=site_url('website_skpd/form/'.$row['id'])?>" class="btn btn-xs btn-info">Edit</a>
